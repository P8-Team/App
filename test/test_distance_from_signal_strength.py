...
from src.location.distance_strength_calculations import dbm_to_mw, calc_distance_from_mw_signal_strength, \
...
def test_calc_distance_from_mw_signal_strength_real_data():
    ...
    assert calc_distance_from_mw_signal_strength(1000, 0.001, 5800) == pytest.approx(4.1160761)
    # 1000mW tranmission, -50dBm signal, 5800Mhz frequency
    assert calc_distance_from_mw_signal_strength(1000, 0.00001, 5800) == pytest.approx(41.16076114)
    # 1000mW tranmission, -60dBm signal, 5800Mhz frequency
    assert calc_distance_from_mw_signal_strength(1000, 0.0000001, 5800) == pytest.approx(411.6076114)
    # 1000mW tranmission, -70dBm signal, 5800Mhz frequency
    assert calc_distance_from_mw_signal_strength(1000, 0.00000001, 5800) == pytest.approx(1301.6175544)
    # 1000mW tranmission, -80dBm signal, 5800Mhz frequency
    assert calc_distance_from_mw_signal_strength(1000, 0.000000001, 5800) == pytest.approx(4116.0761144)
...
def test_calc_distance_from_mw_signal_strength_with_zero_r_fails():
    with pytest.raises(ZeroDivisionError):
        calc_distance_from_mw_signal_strength(100, 0, 3000)


def test_calc_distance_from_mw_signal_strength_with_zero_frequency_fails():
    with pytest.raises(ZeroDivisionError):
        calc_distance_from_mw_signal_strength(100, 100, 0)
...
def test_calc_distance_from_mw_signal_strength_with_negative_frequency_fails():
    ...
    with pytest.raises(ValueError):
        calc_distance_from_mw_signal_strength(100, 100, -3000)
