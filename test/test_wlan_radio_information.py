...
def test_wlan_radio_information():
    ...
    # Act
    wlan_radio_information = WlanRadioInformation.from_layer(layer, WifiCard("wlan0", [0, 0]), 0)
...
def test_compare_wlan_radio_information_identical():
    ...
    # Act
    wlan_radio_information1 = WlanRadioInformation.from_layer(layer1, WifiCard("wlan0", [0, 0]), 0)
    wlan_radio_information2 = WlanRadioInformation.from_layer(layer2, WifiCard("wlan0", [0, 0]), 0)
